  ...
  <div id="is_tbl">
    ...
    <table>
      <thead>
          <tr>
            <th></th>
            <th @click="setIsPeriod">2023</th>
            <th @click="setIsPeriod">2022</th>
            <th @click="setIsPeriod">2021</th>
          </tr>
      </thead>
      <tbody>
        <tr class="sector"><td>Revenue</td>
        ...
        <tr class="sector"><td>Total Liabilities</td>
            <td>{{(0).toLocaleString()}}</td>
            <td>{{(0).toLocaleString()}}</td>
            <td>{{(0).toLocaleString()}}</td>
        </tr>
...
export default {
    methods: {
        setIsPeriod() { this.$emit('IsPeriod', 'Q'); }
    }
}
</script>
